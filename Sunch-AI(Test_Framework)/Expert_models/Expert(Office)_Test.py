...
class Expert:
    def __init__(self):
        ...
        os.environ["CUDA_VISIBLE_DEVICES"] = port["Expert(Office)_Test.py"][0]  # 讓 Expert AI 只使用 GPU 1
        ...
        self.socket.bind(f"tcp://*:{port["Expert(Office)_Test.py"][1]}")  # 監聽端口，等待 Decision AI 連接
